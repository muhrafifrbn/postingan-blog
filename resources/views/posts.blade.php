          ...
          {{-- <article class="py-8  border-b border-gray-300">
            ...
            <a href="/post/{{ $item->slug }}" class="font-medium text-blue-500 hover:underline">Read More &raquo;</a>
                  ...
                  <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="/post/{{ $item->slug }}">{{ $item->title }}</a></h2>
                      <p class="mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($item->body, 100, '...') }}</p>
                      <div class="flex justify-between items-center">
                          ...
                          <a href="/post/{{ $item->slug }}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                              Read more
